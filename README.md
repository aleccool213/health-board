...
`public/favicon.svg`, the PNG icons, and `public/og.png` (1200×630 unfurl card) are generated by `npm run brand` (`scripts/render-brand.mjs`, Playwright + Chromium). Re-run it to refresh the card's workout heatmap from `src/data/workouts.json`.
